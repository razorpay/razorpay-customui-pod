...
- (void)prefetchAndLinkUpiAccountsWithLinkActionDelegate:(id _Nonnull)linkActionDelegate;
@end

@protocol UPITurboTPVPlugin;

SWIFT_PROTOCOL("_TtP8Razorpay14UPITurboPlugin_")
@protocol UPITurboPlugin <UPITurboPrefetchProtocol>
...
@protocol UPITurboUIPlugin <UPITurboPrefetchWithUIProtocol>
