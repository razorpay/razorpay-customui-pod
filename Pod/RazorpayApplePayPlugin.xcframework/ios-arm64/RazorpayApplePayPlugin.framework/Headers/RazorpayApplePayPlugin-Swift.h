...
#ifndef RAZORPAYAPPLEPAYPLUGIN_SWIFT_H
#define RAZORPAYAPPLEPAYPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RazorpayApplePayPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22RazorpayApplePayPlugin8ApplePay")
...
SWIFT_CLASS("_TtC22RazorpayApplePayPlugin14ApplePayEntity")
