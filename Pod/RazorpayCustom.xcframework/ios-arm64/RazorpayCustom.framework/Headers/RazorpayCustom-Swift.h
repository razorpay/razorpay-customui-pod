...
#ifndef RAZORPAYCUSTOM_SWIFT_H
#define RAZORPAYCUSTOM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RazorpayCustom",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, strong) id <AmazonWalletPaylaterProtocol> _Nullable amazonPayPlugin;
@property (nonatomic, strong) id <ApplePayPlugin> _Nullable applePayPlugin;
...
SWIFT_CLASS("_TtC14RazorpayCustom6Otpelf")
...
@property (nonatomic, strong) id <UPITurboPlugin> _Nullable upiTurbo;
@property (nonatomic, strong) id <UPITurboUIPlugin> _Nullable upiTurboUI;
@property (nonatomic, strong) id <AmazonWalletPaylaterProtocol> _Nullable amazonPay;
...
+ (RazorpayCheckout * _Nonnull)initWithKey:(NSString * _Nonnull)key andDelegate:(id <RazorpayPaymentCompletionProtocol> _Nonnull)delegate withPaymentWebView:(WKWebView * _Nonnull)merchantWebView AmazonpayPlugin:(id <AmazonWalletPaylaterProtocol> _Nonnull)AmazonpayPlugin SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
...
- (void)getRecommendedInstrumentsWithOptions:(NSDictionary * _Nonnull)options withSuccessCallback:(void (^ _Nonnull)(NSDictionary * _Nonnull))success andFailureCallback:(void (^ _Nonnull)(NSString * _Nonnull))failure;
