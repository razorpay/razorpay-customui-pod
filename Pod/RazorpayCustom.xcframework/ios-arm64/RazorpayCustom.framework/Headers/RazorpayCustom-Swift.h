...
SWIFT_PROTOCOL("_TtP14RazorpayCustom21PluginPaymentDelegate_")
...
SWIFT_CLASS("_TtC14RazorpayCustom18PluginPaymentModel")
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom33RazorpayPaymentCompletionProtocol_")
@protocol RazorpayPaymentCompletionProtocol
...
SWIFT_CLASS("_TtC14RazorpayCustom7Session")
@interface Session : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_PROTOCOL("_TtP14RazorpayCustom11TokenPlugin_")
@protocol TokenPlugin
- (void)initialize:(id _Nonnull)delegate;
@end

SWIFT_PROTOCOL("_TtP14RazorpayCustom34UPITurboLinkedBankAccountsProtocol_")
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom33UPITurboLinkedUpiAccountsProtocol_")
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom24UPITurboPrefetchProtocol_")
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom14UPITurboPlugin_")
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom30UPITurboPrefetchWithUIProtocol_")
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom17UPITurboTPVPlugin_")
@protocol UPITurboTPVPlugin
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom19UPITurboTPVUIPlugin_")
...
SWIFT_PROTOCOL("_TtP14RazorpayCustom16UPITurboUIPlugin_")
