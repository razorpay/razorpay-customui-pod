...
SWIFT_PROTOCOL("_TtP12RazorpayCore27AddressWalletUpdateDelegate_")
@protocol AddressWalletUpdateDelegate
- (UIViewController * _Nullable)viewControllerForPayload:(NSString * _Nonnull)payloadJson completion:(void (^ _Nonnull)(NSString * _Nonnull))completion SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_PROTOCOL("_TtP12RazorpayCore27AmazonAuthorizationDelegate_")
@protocol AmazonAuthorizationDelegate
- (void)onLinkingSuccessful;
- (void)onLinkingFailed:(NSString * _Nonnull)code description:(NSString * _Nonnull)description;
@end

@protocol PluginPaymentDelegate;
@protocol InternalDelegate;
@class WKWebView;
SWIFT_PROTOCOL("_TtP12RazorpayCore28AmazonWalletPaylaterProtocol_")
...
- (void)startAuthorizationWithCustomerId:(NSString * _Nonnull)customerId amazonAuthorizationDelegate:(id <AmazonAuthorizationDelegate> _Nonnull)amazonAuthorizationDelegate;
...
- (void)initiateWithKey_id:(NSString * _Nonnull)key_id;
@property (nonatomic, readonly, strong) id <PluginPaymentDelegate> _Nonnull paymentPlugin;
- (void)canMakePaymentWithCompletion:(void (^ _Nonnull)(BOOL))completion;
...
- (id _Nullable)initWithKey:(NSString * _Nonnull)key andDelegate:(id <RazorpayPaymentCompletionProtocol> _Nonnull)delegate withPaymentWebView:(WKWebView * _Nonnull)merchantWebView ApplePay:(id <ApplePayPlugin> _Nonnull)applePayPlugin SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
...
- (void)getRecommendedInstrumentsWithOptions:(NSDictionary * _Nonnull)options checkoutInstance:(id _Nullable)checkoutInstance withSuccessCallback:(void (^ _Nonnull)(NSDictionary * _Nonnull))success andFailureCallback:(void (^ _Nonnull)(NSString * _Nonnull))failure;
...
SWIFT_PROTOCOL("_TtP12RazorpayCore16InternalDelegate_")
@protocol InternalDelegate
- (void)onResponseWithResponse:(NSString * _Nonnull)response paymentId:(NSString * _Nullable)paymentId;
@end
...
SWIFT_PROTOCOL("_TtP12RazorpayCore21RazorpayEventCallback_")
@protocol RazorpayEventCallback
- (void)onEvent:(NSString * _Nonnull)payloadJson;
@end
