...
#ifndef RAZORPAYAPPLEPAY_SWIFT_H
#define RAZORPAYAPPLEPAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RazorpayApplePay",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16RazorpayApplePay8ApplePay")
@interface ApplePay : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
+ (id <ApplePayPlugin> _Nonnull)pluginInstance SWIFT_WARN_UNUSED_RESULT;
@end

@class NSString;
@protocol PluginPaymentDelegate;
SWIFT_CLASS("_TtC16RazorpayApplePay14ApplePayEntity")
